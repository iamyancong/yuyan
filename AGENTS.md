...
凡是用户要求“提交代码”“发布 Branch”“推送”或任何会产生 Git commit/push 的任务，默认必须完成 `feat/github-actions-build` 到 `yuyan-3.0` 的双分支闭环；只有用户明确说“只提交 App 分支”或“不要同步 yuyan-3.0”时才允许跳过，并在最终回复中说明原因。
