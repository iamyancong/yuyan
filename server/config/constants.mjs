...
export const TEMPLATE_REPO_URL =
  process.env.TEMPLATE_REPO_URL || 'http://192.168.167.142:8081/Data-Middleground-Develop-Area/product-code/ai-frontend/yss-frontend-template.git';

/** 模板仓库分支名 */
export const TEMPLATE_BRANCH = process.env.TEMPLATE_BRANCH || 'template';

/** GitLab 服务地址 */
export const GITLAB_HOST = process.env.GITLAB_HOST || 'http://192.168.167.142:8081';

/** GitLab 访问 Token */
export const GITLAB_TOKEN = process.env.GITLAB_TOKEN || '';

/** Git 用户名 */
export const GIT_USER_NAME = process.env.GIT_USER_NAME || 'yuyan-ops';

/** Git 用户邮箱 */
export const GIT_USER_EMAIL = process.env.GIT_USER_EMAIL || 'wangyancong@ysstech.com';
